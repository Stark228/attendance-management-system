...
urlpatterns = [
    ...
    path("staff/attendance/sav/",
         staff_views.sav_attendance, name='sav_attendance'),
    path('staff/attendance/webcam_stream/', staff_views.webcam_stream, name='webcam_stream'),
    path("student/view/leave/", staff_views.view_student_leave,
